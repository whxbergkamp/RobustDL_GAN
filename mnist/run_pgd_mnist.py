...
from adversarial_networks.train_pgd_mnist import train
import pprint
...
parser.add_argument('--log-dir', default='./logs_pgd_mnist', type=str, help='Where to store log and checkpoint files.')
parser.add_argument('--model-file', default='./model_pgd_mnist.ckpt', type=str, help='checkpoint file for fgs model.')
