# experiment on standard undefended modelimport os
import argparse

from adversarial_networks.train_standard_mnist import train
import pprint
...
parser.add_argument('--log-dir', default='./logs_std_mnist', type=str, help='Where to store log and checkpoint files.')
parser.add_argument('--model-file', default='./model_std_mnist.ckpt', type=str, help='checkpoint file for fgs model.')
