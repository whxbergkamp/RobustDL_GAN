...
from adversarial_networks.train_standard_cifar10 import train
...
parser.add_argument('--log-dir', default='./logs_std_cifar10', type=str, help='Where to store log and checkpoint files.')
parser.add_argument('--model-file', default='./model_std_cifar10.ckpt', type=str, help='checkpoint file for fgs model.')
