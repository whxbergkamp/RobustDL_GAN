...
from adversarial_networks.train_pgd_svhn import train
import pprint
...
parser.add_argument('--log-dir', default='./logs_svhn_pgd', type=str, help='Where to store log and checkpoint files.')
parser.add_argument('--model-file', default='./model_svhn_pgd.ckpt', type=str, help='checkpoint file for fgs model.')
