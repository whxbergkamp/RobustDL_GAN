...
def resnet_v1(inputs, training, data_format):
    ...
    inputs = tf.layers.dense(inputs=inputs, units=10, kernel_initializer=tf.truncated_normal_initializer(0.0, 0.02))
